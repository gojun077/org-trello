...
Original path to file: `.claude/commands/test.md` in the `org-trello`
project folder.

I'll intelligently run tests based on your current context and actively
help fix failures for Emacs Lisp code.
...
**Real-time Monitoring of Test Suite:**

Test suite can be executed via `make test`
